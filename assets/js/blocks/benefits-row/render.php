...
<section <?php echo get_block_wrapper_attributes(['class' => 'bg-surface py-8 sm:py-16']); ?>>
  <div class="mx-auto max-w-shell px-4">
    ...
    <?php endif; ?>
    <div class="mt-10 grid grid-cols-3 gap-x-3 gap-y-8 text-center md:gap-8">
  <?php foreach ($benefits as $i => $b) :
      ...
      $delay = $i * 100;
  ?>
    <div data-anim <?php echo $delay ? 'data-anim-delay="' . esc_attr($delay) . '"' : ''; ?> class="flex flex-col items-center px-1 md:px-4">
